import { ArrowRight, ShieldCheck, Mail, LayoutGridIcon, PlusIcon, ShareIcon, Sparkles, Terminal, Layers, Eye, Zap, Lock } from "lucide-react"
...
const handlestart=() => {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-[#a3a3a3] font-sans antialiased selection:bg-indigo-500/10 flex flex-col justify-between">
      ...
      <header className="w-full border-b border-[#161616] bg-[#0c0c0c]/80 backdrop-blur-md fixed top-0 left-0 z-50">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 md:px-8 py-4">
          ...
          <div className="flex items-center gap-3">
            <a href="/signin" className="text-xs font-semibold text-[#525252] hover:text-[#e5e7eb] transition-colors px-3 py-1.5">
              Sign In
            </a>
            <button
            onClick={handlestart} 
              type="button"
              className="font-semibold tracking-wide transition-all duration-300 flex items-center justify-center border border-transparent bg-[#ffffff] text-[#050505] rounded-xl text-xs gap-1.5 px-4 py-2 shadow-sm hover:shadow-[0_0_15px_rgba(255,255,255,0.15)]"
            >
              <span>Initialize Vault</span>
              <ArrowRight size="1.05em" />
            </button>
          </div>
        </div>
      </header>

      {/* 2. Hero Section: High-End Minimal Vector Hub Showcase */}
      <main className="pt-28 flex-1">
        <section className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 pt-12 md:pt-20 pb-16 text-center space-y-6">
          ...
          {/* Simulated Interface Grid Preview Block */}
          <div id="preview" className="pt-16 max-w-5xl mx-auto">
            <div className="bg-[#0c0c0c] border border-[#1c1c1c] rounded-2xl p-4 sm:p-6 shadow-[0_0_50px_rgba(255,255,255,0.02)] text-left space-y-6">
              
              {/* Header Interface simulation block */}
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#161616] pb-6">
                <div>
                  <h3 className="text-base font-bold tracking-tight text-white">All Captured Memories</h3>
                  <p className="text-[11px] text-[#525252] mt-0.5">Live visualization matrix.</p>
                </div>
                <div className="flex items-center gap-2 self-start sm:self-auto">
                  <div className="px-3 py-1.5 text-[11px] font-semibold bg-[#121212] border border-[#222222] text-[#e5e7eb] rounded-xl flex items-center gap-1.5">
                    <ShareIcon size="0.9em" className="text-[#525252]"/> Share Hub
                  </div>
                  <div className="px-3 py-1.5 text-[11px] font-semibold bg-white text-[#050505] rounded-xl flex items-center gap-1.5">
                    <PlusIcon size="0.9em"/> Add Memory
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {/* Simulated Card 1 */}
                <div className="bg-[#0d0d0d] border border-[#181818] rounded-xl p-5 space-y-4 shadow-[0_0_15px_rgba(255,255,255,0.01)]">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="p-1.5 bg-[#141414] border border-[#1f1f1f] rounded-lg text-xs text-red-400">📺</div>
                      <span className="text-[9px] uppercase font-mono tracking-widest font-bold text-[#525252]">youtube</span>
                    </div>
                    <span className="text-[9px] font-mono text-[#404040]">2m ago</span>
                  </div>
                  <h4 className="text-xs font-semibold text-[#f3f4f6]">Distributed System Consensus algorithms, Raft Explained</h4>
                  <div className="h-24 rounded-lg bg-[#070707] border border-[#141414] flex items-center justify-center text-[10px] font-mono text-[#404040]">
                    [ EMBED_VIDEO_STREAM ]
                  </div>
                </div>
                {/* Simulated Card 2 */}
                <div className="bg-[#0d0d0d] border border-[#181818] rounded-xl p-5 space-y-4 shadow-[0_0_15px_rgba(255,255,255,0.01)]">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="p-1.5 bg-[#141414] border border-[#1f1f1f] rounded-lg text-xs text-emerald-400">📝</div>
                      <span className="text-[9px] uppercase font-mono tracking-widest font-bold text-[#525252]">blog</span>
                    </div>
                    <span className="text-[9px] font-mono text-[#404040]">1h ago</span>
                  </div>
                  <h4 className="text-xs font-semibold text-[#f3f4f6]">PostgreSQL indexing strategies under heavy read-write loads</h4>
                  <div className="p-3 rounded-lg bg-[#070707] border border-[#141414] flex items-center justify-between text-[10px] font-mono text-[#525252]">
                    <span className="truncate max-w-[80%]">https://postgres.spec/indexing-heavy-loads</span>
      ...
      {/* 3. Features Section: Core Modules Grid Layout */}
      <section id="features" className="w-full bg-[#0c0c0c] border-y border-[#161616] py-20 md:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          {/* Strictly 2 Columns Grid layout with increased card padding and size */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            
            {/* Feature Item 1 */}
            <div className="bg-[#050505] border border-[#1c1c1c] p-8 sm:p-10 rounded-xl space-y-4 transition-all duration-300 hover:border-[#333333] hover:shadow-[0_0_20px_rgba(255,255,255,0.04)] min-h-[240px] flex flex-col justify-between">
              <div className="space-y-4">
                <div className="h-9 w-9 rounded-lg bg-[#141414] border border-[#1f1f1f] flex items-center justify-center text-white">
                  <Layers size="1.15em" />
                </div>
                <h3 className="text-sm font-bold uppercase tracking-wider text-white">Multi-Format Sync</h3>
                <p className="text-xs leading-relaxed text-[#666666]">Effortlessly catalog complex notes, deep YouTube structures, internal links, and social items seamlessly.</p>
              </div>
            </div>
            ...
            <div className="bg-[#050505] border border-[#1c1c1c] p-8 sm:p-10 rounded-xl space-y-4 transition-all duration-300 hover:border-[#333333] hover:shadow-[0_0_20px_rgba(255,255,255,0.04)] min-h-[240px] flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <h3 className="text-sm font-bold uppercase tracking-wider text-white">Ambient Glow Focus</h3>
            ...
            <div className="bg-[#050505] border border-[#1c1c1c] p-8 sm:p-10 rounded-xl space-y-4 transition-all duration-300 hover:border-[#333333] hover:shadow-[0_0_20px_rgba(255,255,255,0.04)] min-h-[240px] flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <h3 className="text-sm font-bold uppercase tracking-wider text-white">Instant Capture Vectors</h3>
            ...
            <div className="bg-[#050505] border border-[#1c1c1c] p-8 sm:p-10 rounded-xl space-y-4 transition-all duration-300 hover:border-[#333333] hover:shadow-[0_0_20px_rgba(255,255,255,0.04)] min-h-[240px] flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <p className="text-xs leading-relaxed text-[#666666]">Your workspaces are mapped using hardcoded hash references to isolate and secure data packets perfectly.</p>
              </div>
            </div>
      ...
      {/* 4. Bottom Static Call-To-Action (CTA) Platform Frame */}
      <section id="architecture" className="max-w-4xl mx-auto w-full px-4 sm:px-6 md:px-8 py-16 md:py-24 text-center">
        <div className="bg-[#0c0c0c] border border-[#1c1c1c] rounded-2xl p-6 sm:p-10 space-y-6 shadow-[0_0_30px_rgba(255,255,255,0.03)]">
          <div className="flex justify-center">
            <div className="p-3 bg-[#070707] border border-[#141414] rounded-xl">
              <ShieldCheck size="1.5em" className="text-white" />
            </div>
          </div>
          ...
          <div className="pt-2 flex justify-center">
            <button 
              type="button"
              className="font-semibold tracking-wide transition-all duration-300 flex items-center justify-center border border-transparent bg-[#ffffff] text-[#050505] rounded-xl text-xs gap-1.5 px-6 py-3 shadow-sm hover:shadow-[0_0_15px_rgba(255,255,255,0.15)]"
            >
      ...
      <footer className="w-full max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 px-4 sm:px-6 md:px-8 py-6 border-t border-[#161616]/40 text-[10px] font-mono tracking-tight text-[#404040]">
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="text-[#1f1f1f]">•</span>
          <span className="text-[#525252]">NODE_STATUS: ONLINE</span>
        </div>
      </footer>
