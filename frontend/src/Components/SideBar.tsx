...
export function SideBar({
  ...
  return (
    <>
      <div
        className={`
          fixed px-5 pt-7 pb-6 left-0 top-0 z-50
      ...
      >
        ...
        <div className="flex flex-col flex-1 min-h-0">
            ...
            <div className="flex items-center gap-3">
              <div
                className={`h-8 w-8 rounded-xl flex items-center justify-center text-md font-bold shadow-xs ${
                  darkMode ? "bg-[#1a1a1a] text-white" : "bg-slate-900 text-white"
                }`}
              >
                <svg
          ...
          <div className="flex flex-col flex-1 w-full overflow-y-auto pb-4 custom-scrollbar">
